...
The standard library uses `std/<name>` import paths and currently includes:
...
Use these split references for stdlib details:

- [references/stdlib-overview.md](references/stdlib-overview.md) — package index, import guidance, and package-selection quick map
- [references/stdlib-assert-and-testing.md](references/stdlib-assert-and-testing.md) — `std/assert` API and testing patterns
- [references/stdlib-data-and-io.md](references/stdlib-data-and-io.md) — `std/blob`, `std/fs`, `std/http`, `std/json`, `std/path`, `std/stream`
- [references/stdlib-crypto-and-os.md](references/stdlib-crypto-and-os.md) — `std/crypto`, `std/os`
- [references/stdlib-regex-and-time.md](references/stdlib-regex-and-time.md) — `std/regex`, `std/time`
