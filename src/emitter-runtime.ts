...
const OBSERVER_PLATFORM_SUPPORT = String.raw`
#if defined(_WIN32)
#define NOMINMAX
#include <winsock2.h>
#include <ws2tcpip.h>
...
function buildObserverRuntimeSupport(): string {
    const assets = loadObserverAssets();
    return String.raw`
// ============================================================================
// Observer — local runtime dashboard
// ============================================================================

namespace observe {

inline const char* _asset_html = ${cxxRawLiteral(assets.html)};
inline const char* _asset_css = ${cxxRawLiteral(assets.css)};
inline const char* _asset_js = ${cxxRawLiteral(assets.js)};
