...
const SELFHOST_MODULES = [
  ...
  "checker-types.do", "json-semantics.do", "checker-actor-boundary.do", "checker-actor-lifecycle.do", "checker.do",
  "emitter-context.do", "emitter-monomorphize.do", "emitter-types.do",
  "emitter-expr-utils.do", "emitter-expr-literals.do", "emitter-expr-ops.do",
  "emitter-expr-calls.do", "emitter-expr-control.do", "emitter-expr-actor.do", "emitter-expr-lambda.do",
